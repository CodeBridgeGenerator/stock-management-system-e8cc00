...
const CategoriesDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
    const urlParams = useParams();
    const [showUpload, setShowUpload] =useState(false)

const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.categoryname}</p>
...
<Column field="categoryname" header="Category Name" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
