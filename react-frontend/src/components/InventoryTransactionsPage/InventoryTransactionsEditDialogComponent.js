...
lens: _entity?.lens?._id,
        ...
        await client.service("inventoryTransactions").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info inventoryTransactions updated successfully" });
    ...
    return (
        <Dialog header="Edit InventoryTransaction" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="inventoryTransactions-edit-dialog-component">
