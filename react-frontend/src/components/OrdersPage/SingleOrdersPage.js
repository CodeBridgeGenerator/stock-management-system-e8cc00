...
const SingleOrdersPage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Order Date</label><p className="m-0 ml-3" >{_entity?.orderdate}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Order Status</label><p className="m-0 ml-3" >{_entity?.orderstatus}</p></div>
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm">Customer ID</label>
            <p>{customerid.map((elem) => (
