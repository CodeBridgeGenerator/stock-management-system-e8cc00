...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.orderdate}</p>
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.customerid?.name}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.orderstatus}</p>
...
<Column field="orderdate" header="Order Date" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
<Column field="customerid" header="Customer ID" body={dropdownTemplate1} style={{ minWidth: "8rem" }} />
<Column field="orderstatus" header="Order Status" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
